...
const FORBIDDEN: Array<[string, RegExp]> = [
  ...
  // hit exactly that false positive in all four locales. Same family:
  // "day-N support" is release vocabulary, not storyline filler — the
  // fil locale's "day-one na suporta" hit it 2026-07-10, so any day-N
