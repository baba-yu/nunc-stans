...
def test_parse_real_file():
    ...
    # Locale-aware lookup (feature/locale): per-locale subdirs first.
    candidates = [
        repo / "future-prediction" / "en" / "future-prediction-20260424.md",
        repo / "future-prediction" / "ja" / "future-prediction-20260424.md",
        repo / "future-prediction" / "future-prediction-20260424.md",
    ]
